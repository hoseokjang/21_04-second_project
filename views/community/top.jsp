...
<style>
	...
	#side_menu_top
	{
		...
		width:auto;
		top:820px;
		left:1730px; /* 가로 위치는 파일을 옮기면 1500~1600 사이로 변경 */
	}
</style>
<body>
    <!-- Page Preloder -->
                                ...
                                <li><a href="#">고객센터</a>
                                	<div class="header__megamenu__wrapper" align="center">
                                        <div class="header__megamenu">
                                            ...
                                            <div class="header__megamenu__item">
                                                    <div class="label"><a href="gongji_qna">자주 묻는 질문</a></div>
                                            </div>
                                            <div class="header__megamenu__item">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__btn">
                        ...
                        <c:if test="${userid != null }">
                        	...
                        	<c:if test="${userid == 'admin' }">
                        		<a href="admin" class="primary-btn">관리자모드</a><a href="logout" class="primary-btn">로그아웃</a>
                        	</c:if>
                        </c:if>
                    </div>
                </div>
