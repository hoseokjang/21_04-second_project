...
<div align="center">
<caption > <h3> 관리자 계정관리 페이지 </h3> </caption>
 <table width="800" align="center">
   ...
   <c:forEach var="mdto" items="${mlist}">
    <tr align="center">
     ...
     <c:if test="${mdto.mstate == 3}">
      <td colspan="2"> <a href="adm_state?id=${mdto.id}&mstate=4"> 관리계정 정지 </a></td>     </c:if>
     
     <c:if test="${mdto.mstate == 4}">
      <td colspan="2"> <a href="adm_state?id=${mdto.id}&mstate=3"> 관리계정 복원  </a> </td>
     </c:if>
    </tr>
   </c:forEach> 
  </table>
